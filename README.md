...
1. 在 Releases 点击“光环工坊_0.3.2.zip”，下载后完整解压。
   GitHub 下载文件名为 `DBO-Aura_0.3.2_Windows_x64.zip`，解压后的文件夹为 `光环工坊_0.3.2`。
2. 双击 `光环工坊 作者：Spike.exe`，保留同目录 `_internal` 文件夹。
3. 在“语言 / Language”选择简体中文或 English，选择会在重启后保留。
4. 从“创建向导”开始，保存 `.aura` 工程，再导出游戏资源 ZIP。
5. 默认启动检查更新，也可打开“帮助 → 检查更新…”。下载和安装分别需要确认。

**0.3.1 及更早版本需要先手动解压安装一次 0.3.2；之后可在软件内升级。**

![光环工坊中文界面](预览/中文主界面.png)
...
- 在线更新、下载校验、安装前保存提示及旧程序备份；保留工程和工作数据。
...
压缩包只包含这些仓库文件；运行程序请下载 `光环工坊_0.3.2.zip`。
...
Use **Help → Check for updates** for online updates. Startup checks are enabled
by default. Download and installation require separate confirmation. Versions
0.3.1 and earlier need one manual upgrade to 0.3.2 first.
